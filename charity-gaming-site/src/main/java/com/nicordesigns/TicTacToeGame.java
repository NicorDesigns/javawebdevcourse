...
public class TicTacToeGame
{
    ...
    private static final Hashtable<Long, String> pendingGames = new Hashtable<Long, String>();
    private static final Map<Long, TicTacToeGame> activeGames = new Hashtable<Long, TicTacToeGame>();
